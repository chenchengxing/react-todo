...
},{"./app.jsx":2,"react":147}],2:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
var app = React.createClass({displayName: 'app',
  ...
  render: function() {
    ...
    todoItems = todoItems.map(function (item) {
      return ytListItem({name: item.name, itemClick: self.itemClick.bind(this, item)})
    }, this);

    var footer;
    if (todoItems.length) {
      footer = ytFooter({leftCount: todoItems.length})
    } else {
      footer = null;
    }
    return (
...
module.exports = app;
},{"./ytFooter.jsx":148,"./ytHeader.jsx":149,"./ytListItem.jsx":150,"react":147}],3:[function(require,module,exports){
...
var ytFooter = React.createClass({displayName: 'ytFooter',

  render: function() {
    return (
      React.DOM.footer(null, 
        React.DOM.span(null, React.DOM.strong(null, this.props.leftCount), "todo")
      )
    );
  }
...
var ytHeader = React.createClass({displayName: 'ytHeader',

  render: function() {
    return (
      React.DOM.header(null, 
        React.DOM.h1(null, "TODOs"), 
        React.DOM.input({type: "text", ref: "inputss", onKeyDown: this.props.keydown}), 
        React.DOM.button({onClick: this.props.addTodo}, "enter")
      )
    );
  }
...
var ytListItem = React.createClass({displayName: 'ytListItem',
  ...
  render: function() {
    ...
    return (
      React.DOM.li(null, 
        this.props.name, 
        React.DOM.a({onClick: this.props.itemClick, className: "btn-done"}, "mark as DONE")
      )
    );
  }
